...
CREATE TABLE search_history (
  ...
  sources TEXT[] DEFAULT ARRAY['internal'],
  metadata JSONB DEFAULT '{}'::jsonb,
  created_at TIMESTAMPTZ DEFAULT NOW()
);

CREATE INDEX IF NOT EXISTS idx_search_history_sources ON search_history USING GIN(sources); -- Index for sources
...
-- Helper Functions from migration 003 (related to api_cache and rate_limits)
