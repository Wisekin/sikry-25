...
-- api_cache table is managed via scripts/013-search-rate-limit.sql
...
CREATE INDEX IF NOT EXISTS idx_search_history_sources ON search_history USING GIN(sources); -- Index for sources UPDATED ON 2025-06-23
...
-- Helper functions related to api_cache and rate_limits are now managed in scripts/013-search-rate-limit.sql